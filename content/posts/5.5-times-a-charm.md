...
{{ figure(src="/posts/5.5-times-a-charm/old-site-work-entries.png", caption="The Work Page on my old site. It will be missed!") }}
...
{{ figure(src="/posts/5.5-times-a-charm/rogers-website.png", caption="Xiu-Zhe (Roger) Luo's Website using the AstroPaper theme") }}

{{ figure(src="/posts/5.5-times-a-charm/cduck-website.png", caption="Casey Duckering's Website") }}
...
*If you’d like to get in touch to leave a comment, please reach out via my e-mail: (my first name)z(first letter of my last name).dev@gmail.com*
